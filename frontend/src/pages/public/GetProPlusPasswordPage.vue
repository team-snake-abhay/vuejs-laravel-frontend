<template>
  <q-page class="row items-center justify-evenly">
    <div class="col-auto">
      <h3>Welcome to Storify</h3>
      <!-- forget  -->
      <q-card>
        <q-card-section class="q-pa-xl" style="max-width: 650px">
          <div class="row">
            <div class="col-12 q-mb-md">
              <p>
                You will get your Storify account password here. <br />
                Please provide us the email address you used to purchase on
                JVZoo Platform.
              </p>
              <br />
              <label>
