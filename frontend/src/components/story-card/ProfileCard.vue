<template>
  <q-card class="story-card profile-card q-pt-lg">
    <div class="text-center">
      <div
        :style="
          props.profileObj.profileImage
            ? `background-image: url(` + props.profileObj.profileImage + `)`
            : ''
        "
      ></div>
      <q-avatar size="100px" class="bg-primary">
        <q-icon v-if="!props.profileObj.profileImage" name="o_account_circle" />
        <q-img v-else :ratio="1" :src="props.profileObj.profileImage"></q-img>
      </q-avatar>
    </div>

    <q-card-section class="text-center">
      <div class="col-12 text-h6 ellipsis">
        {{ props.profileObj.firstName }} {{ props.profileObj.lastName }}
      </div>
      <div class="enterpriseTitle">
        {{ props.profileObj.enterpriseTitle }}
      </div>
      <div class="col-12">
        <q-btn
          v-if="!!props.profileObj.twitter"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.twitter"
          target="_blank"
        >
          <svg
        ...
        <q-btn
          v-if="!!props.profileObj.linkedin"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.linkedin"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <q-btn
          v-if="!!props.profileObj.facebook"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.facebook"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <q-btn
          v-if="!!props.profileObj.instagram"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.instagram"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <q-btn
          v-if="!!props.profileObj.youtube"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.youtube"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <q-btn
          v-if="!!props.profileObj.website"
          round
          flat
          color="transparent"
          :to="'//' + props.profileObj.website"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
...
onMounted(() => {
  console.log('onMounted ProfileCard');
});
</script>
